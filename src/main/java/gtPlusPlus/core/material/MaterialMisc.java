...
public final class MaterialMisc {
    ...
    public static final Material POTASSIUM_NITRATE = new Material(
        ...
        0,
        false,
        new MaterialStack(MaterialsElements.getInstance().POTASSIUM, 1),
    ...
    public static final Material SELENIOUS_ACID = new Material(
        ...
        new MaterialStack(MaterialsElements.getInstance().HYDROGEN, 8),
    ...
    public static final Material WOODS_GLASS = new Material(
        ...
        0,
        false,
        new MaterialStack(MaterialsElements.getInstance().SILICON, 40),
        new MaterialStack(MaterialsElements.getInstance().BARIUM, 30),
        new MaterialStack(MaterialsElements.getInstance().SODIUM, 20),
        new MaterialStack(MaterialsElements.getInstance().NICKEL, 10));
    ...
    public static final Material RARE_EARTH_LOW = new Material(
        ...
        -1,
        -1, // Radiation
        new MaterialStack[] { new MaterialStack(MaterialsOres.GREENOCKITE, 1),
            new MaterialStack(MaterialsOres.LANTHANITE_CE, 1), new MaterialStack(MaterialsOres.AGARDITE_CD, 1),
            new MaterialStack(MaterialsOres.YTTRIALITE, 1),
            ...
            new MaterialStack(MaterialsOres.CRYOLITE, 1),
    ...
    public static final Material RARE_EARTH_HIGH = new Material(
        ...
        -1,
        -1, // Radiation
        new MaterialStack[] { new MaterialStack(MaterialsOres.GADOLINITE_Y, 1),
            new MaterialStack(MaterialsOres.LEPERSONNITE, 1), new MaterialStack(MaterialsOres.FLORENCITE, 1),
            new MaterialStack(MaterialsOres.FLUORCAPHITE, 1), new MaterialStack(MaterialsOres.LAUTARITE, 1),
            new MaterialStack(MaterialsOres.DEMICHELEITE_BR, 1), new MaterialStack(MaterialsOres.ALBURNITE, 1),
            new MaterialStack(MaterialsOres.SAMARSKITE_Y, 1), new MaterialStack(MaterialsOres.AGARDITE_LA, 1), });
    ...
    public static final Material AMMONIA = new Material(
        ...
        // Material Stacks with Percentage of required elements.
        new MaterialStack(MaterialsElements.getInstance().NITROGEN, 1),
        new MaterialStack(MaterialsElements.getInstance().HYDROGEN, 3));
    ...
    public static final Material ACETIC_ANHYDRIDE = new Material(
        ...
        0,
        true,
        new MaterialStack(MaterialsElements.getInstance().CARBON, 4),
    ...
    public static final Material CHLOROACETIC_MIXTURE = new Material(
        ...
        0,
        true,
        new MaterialStack(MaterialsElements.getInstance().CARBON, 6),
        new MaterialStack(MaterialsElements.getInstance().HYDROGEN, 6),
        new MaterialStack(MaterialsElements.getInstance().OXYGEN, 6),
        new MaterialStack(MaterialsElements.getInstance().CHLORINE, 6));
    ...
    public static final Material COPPER_SULFATE = new Material(
        ...
        0,
        false,
        new MaterialStack(MaterialsElements.getInstance().COPPER, 1),
        new MaterialStack(MaterialsElements.getInstance().SULFUR, 1),
        new MaterialStack(MaterialsElements.getInstance().OXYGEN, 4));
    ...
    public static final Material MUTATED_LIVING_SOLDER = new Material(
        ...
        new MaterialStack(MaterialsElements.getInstance().BISMUTH, 1));
}
